<div class="dark:bg-gray-800 max-w-1/2 W-1/2 ">
    <div class="p-1 mb-4 text-xl text-center rounded-lg  text-white bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-800 shadow-lg shadow-gray-500/50 dark:shadow-lg dark:shadow-gray-800/80" role="alert">
        ...
        <div class="container py-10 px-10 mx-0 min-w-full flex flex-col items-center">
            <button class="text-white bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-800 shadow-lg shadow-gray-500/50 dark:shadow-lg dark:shadow-gray-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"><a href="https://wa.me/5216721742590?text=Hola+qué+tal!+Aparte+los+siguientes+numeros+{{$comprados}}.%0A%0AEn+la+Edición+{{ $data->descripcion }}%0A%0ANombre:+{{$nombre}}%0A%0AAtención%0A%0A------------------------------------------%0A%0AEl siguiente paso es enviar foto del comprobante de pago por aquí%0A%0ATus boletos quedan apartados por 24 hrs%0A%0A">TERMINAR</a></button>
          </div>
