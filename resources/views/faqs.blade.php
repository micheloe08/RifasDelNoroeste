<div class="dark:bg-gray-800 max-w-7xl2">
    ...
    <div class="grid gap-4 mb-4 md:grid-cols-1">
        <a href="/venta" wire:navigate> <button type="button" class="focus:outline-none text-white bg-gray-400 hover:bg-gray-500 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-gray-900">Compra tus boletos aqui ☝🏻</button> </a>
     </div>
     <div class="pt-2">

     </div>
     <div class="grid gap-4 mb-4 md:grid-cols-1">
        <a> <button wire:click="$set('consulta', true)" type="button" class="focus:outline-none text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Consulta tus boletos aqui! 🎫🤞🏻</button> </a>
     </div>
    </div>
    <div class="pt-2">
